...
namespace PhotoGallery.Web.Areas.Identity.Pages.Account.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string GalleriesNavClass(ViewContext viewContext) => PageNavClass(viewContext, Galleries);
        ...
        private static string PageNavClass(ViewContext viewContext, string page)
        {
            ...
            {
                activePage = System.IO.Path.GetFileNameWithoutExtension(viewContext.ActionDescriptor.DisplayName) ?? string.Empty;
            }
